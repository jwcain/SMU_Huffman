...
Purpose/Theory:
	...
	The code was tested on:
		...
		The remaining test case I would like to have tested on would be a file that contains at least one of each
		unique byte. I was unable to generate this file for testing before I ran out of time.
